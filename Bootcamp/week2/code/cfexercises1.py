...
"""
Some functions using control flows for basic calculations.

This script includes a set of functions for various basic calculations:
finding the square root, comparing numbers, sorting numbers, and calculating factorials
using different methods. It also includes embedded tests for each function.
"""
